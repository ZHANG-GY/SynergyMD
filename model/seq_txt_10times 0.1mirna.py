# -*- coding: utf-8 -*-
"""
Created on Wed Dec 31 16:30:58 2025
...
ax1.text(-0.1, 1.05, '(c)', transform=ax1.transAxes, 
...
ax2.text(-0.1, 1.05, '(d)', transform=ax2.transAxes, 
         fontsize=20, fontweight='bold')
...
with open(r'D:\数据\sample\10times seq txt 0.1mir fpr.pkl','wb')as f:
    pickle.dump(fpr_list,f)  
with open(r'D:\数据\sample\10times seq txt 0.1mir tpr.pkl','wb')as f:
    pickle.dump(tpr_list,f)  
with open(r'D:\数据\sample\10times seq txt 0.1mir precision.pkl','wb')as f:
    pickle.dump(precision_list,f)  
with open(r'D:\数据\sample\10times seq txt 0.1mir recall.pkl','wb')as f:
    pickle.dump(recall_list,f)   
with open(r'D:\数据\sample\10times seq txt 0.1mir ap.pkl','wb')as f:
    pickle.dump(ap_lsit,f)  
with open(r'D:\数据\sample\10times seq txt 0.1mir auc.pkl','wb')as f:
