...
with open(r'D:\数据\sample\10times seq txt 0.1dis fpr.pkl','wb')as f:
    pickle.dump(fpr_list,f)  
with open(r'D:\数据\sample\10times seq txt 0.1dis tpr.pkl','wb')as f:
    pickle.dump(tpr_list,f)  
with open(r'D:\数据\sample\10times seq txt 0.1dis precision.pkl','wb')as f:
    pickle.dump(precision_list,f)  
with open(r'D:\数据\sample\10times seq txt 0.1dis recall.pkl','wb')as f:
    pickle.dump(recall_list,f)   
with open(r'D:\数据\sample\10times seq txt 0.1dis ap.pkl','wb')as f:
    pickle.dump(ap_lsit,f)  
with open(r'D:\数据\sample\10times seq txt 0.1dis auc.pkl','wb')as f:
